...
MENU_BODY = (
    "高频指令\n"
    "  输入 / 可选择英文命令，中文命令仍可直接发送\n"
    "  /快捷回复              打开固定回复按钮，点击会直接发送文字\n"
    "  /隐藏键盘              关闭快捷回复键盘\n"
    "  /自拍                  根据当前上下文生成一张图\n"
    "  /NTR [提示词]          以 NTR 场景模式生成一张图，可选自定义画面提示\n"
    "  /创建角色              逐步创建新的角色卡\n"
    "  /角色 list             查看可切换的角色卡\n"
    "  /角色 load <名称>      切换到指定角色卡\n"
...
DEFAULT_CONFIG = {
    ...
    "animaflow_enabled": False,
    "animaflow_workflow": "anima29_turbo",
    "animaflow_steps": "8",
    "animaflow_cfg": "1.0",
    "animaflow_filename_prefix": "sucyubot_animaflow",
    ...
    "telegram_update_drain_timeout_seconds": "30",
    "telegram_update_max_attempts": "3",
    "telegram_update_retry_base_seconds": "1",
    ...
    "negative_prompt": "bad anatomy, bad hands, extra fingers, extra limbs, deformed, missing limbs, worst quality, low quality, photorealistic, 3d, censor bar, mosaic",
    "dynamic_appearance": "",
    "default_purity": "",
    ...
    # 推送侧网络话题池：每日首次 normal 独立话题推送完成后最多搜索几次（与聊天侧独立计数）。
